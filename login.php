...
<head>
    ...
    <title>SP Penyakit Seksual | Login</title>
...
<div class="container">
    <div class="d-flex align-items-center justify-content-center flex-column pt-5">
        <h1 class="text-uppercase fw-semibold mb-0">Selamat Datang!</h1>
        <p class="text-uppercase text-center mb-5">Sistem Pakar PENYAKIT MENULAR SEKSUAL PADA MANUSIA</p>
